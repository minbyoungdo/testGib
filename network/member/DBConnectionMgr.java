...
public class DBConnectionMgr {
    private Vector connections = new Vector(10);//미리 connection객체를 생성한다.(별도로 close하지 않는다.) pool기법
    private String _driver = "oracle.jdbc.driver.OracleDriver",//이 값은 회사 값이기에 다른 사람에게 알려줘서는 안된다.
