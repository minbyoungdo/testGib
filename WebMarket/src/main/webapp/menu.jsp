		...
		<div>
			<ul class="navbar-nav mr-auto">
				<c:choose>
					...
					<li class="nva-item"><a class="nav-link" href="<c:url value="/member/loginMember.jsp"/>">로그인</a></li>
					<li class="nav-item"><a class="nav-link" href="<c:url value="/member/addMember.jsp"/>">회원 가입</a></li>
					</c:when>
					<c:otherwise>
						<li style="padding-top:px; color:white">[<%=sessionId %>님]</li>
						<li class="nav-item"><a class="nav-link" href="<c:url value="/member/logoutMember.jsp"/>">로그아웃</a></li>
						<li class="nav=item"><a class="nav-link" href="<c:url value="/member/updateMember.jsp"/>">회운 수정</a></li>
