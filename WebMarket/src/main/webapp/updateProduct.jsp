...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-5">
				<img scr="./upload2/<%=rs.getString("p_fileName") %>" alt="image" style="width:100%"/>
			</div>
			<div class="col-md-7">
				<form name="newProduct" action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<itextarea name="description" cols="50" row="2" class="form-control">
							<%= rs.getString("p_description") %></itextarea>
						</div>
					</div>
					<div class="form-group row">
